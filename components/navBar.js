            ...
            <nav className="relative flex flex-wrap items-center justify-between px-2 py-3 bg-white mb-3 sticky top-0 z-30">
                <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                    <div className="w-full relative flex justify-between md:w-auto md:static md:block md:justify-start">
                        <Link href="/">
                            <a><Image  className='cursor-pointer' src='/logo-gangs.png' width={30} height={30}/><span className='text-2xl'>NecroFunda</span><p className='text-2xl'>Dominion Campaign</p></a>
                        </Link>
                        <button
